...
/obj/item/weapon/twohanded/toolboxhammer  // bart simpson was here
...
/obj/item/weapon/twohanded/toolboxhammer/update_icon()  //Currently only here to fuck with the on-mob icons.
...
/obj/item/weapon/twohanded/toolboxhammer/attack(mob/target, mob/living/carbon/human/user)
	..()
	if((wielded) && prob(25))
...
/obj/item/weapon/twohanded/toolboxhammer/proc/robusto_spin(mob/living/user)
